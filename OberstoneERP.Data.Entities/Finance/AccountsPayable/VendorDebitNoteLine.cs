...
/// <summary>
/// Represents a line item on a vendor debit note.
/// </summary>
public class VendorDebitNoteLine : BaseEntity
{
    /// <summary>
    /// Debit note this line belongs to.
    /// </summary>
    public Guid VendorDebitNoteId { get; set; }

    /// <summary>
    /// Line number within the debit note.
    /// </summary>
    ...
    public virtual VendorDebitNote VendorDebitNote { get; set; } = null!;
