...
public class VendorConfiguration : BaseEntityConfiguration<Vendor>
{
    ...
    {
        builder.ToTable("Vendors", "accountspayable");

        builder.Property(e => e.CompanyId).HasColumnType("uniqueidentifier").IsRequired();
        builder.HasIndex(e => e.CompanyId).HasDatabaseName("IX_Vendors_CompanyId");
        builder.Property(e => e.VendorGroupId).HasColumnType("uniqueidentifier");
        builder.Property(e => e.VendorNumber).HasMaxLength(50).IsRequired();
        builder.HasIndex(e => new { e.CompanyId, e.VendorNumber }).IsUnique().HasDatabaseName("IX_Vendors_CompanyId_VendorNumber");
        builder.Property(e => e.Name).HasMaxLength(200).IsRequired();
        builder.HasIndex(e => new { e.CompanyId, e.Name }).HasDatabaseName("IX_Vendors_CompanyId_Name");
        builder.Property(e => e.LegalName).HasMaxLength(300);
        builder.Property(e => e.VendorType).HasConversion<int>().HasDefaultValue(VendorType.Supplier).IsRequired();
        ...
        builder.Property(e => e.PreferredPaymentMethod).HasConversion<int>().HasDefaultValue(PaymentMethod.Check).IsRequired();
        builder.Property(e => e.BankAccountNumber).HasMaxLength(50);
        builder.Property(e => e.BankRoutingNumber).HasMaxLength(50);
        ...
        builder.Property(e => e.AccountsPayableBalance).HasColumnType("decimal(19,4)").HasDefaultValue(0m).IsRequired();
        builder.Property(e => e.DefaultTaxCodeId).HasColumnType("uniqueidentifier");
        builder.Property(e => e.Is1099Required).HasDefaultValue(false).IsRequired();
        builder.Property(e => e.Form1099Type).HasMaxLength(20);
        ...
        builder.HasOne(e => e.VendorGroup).WithMany(vg => vg.Vendors).HasForeignKey(e => e.VendorGroupId).OnDelete(DeleteBehavior.Restrict);
