...
public class VendorDebitNoteLineConfiguration : BaseEntityConfiguration<VendorDebitNoteLine>
{
    ...
    protected override void ConfigureEntity(EntityTypeBuilder<VendorDebitNoteLine> builder)
    {
        ...
        builder.Property(e => e.VendorDebitNoteId).HasColumnType("uniqueidentifier").IsRequired();
        builder.HasIndex(e => e.VendorDebitNoteId).HasDatabaseName("IX_VendorDebitNoteLines_VendorDebitNoteId");
        ...
        builder.HasOne(e => e.VendorDebitNote).WithMany(vdn => vdn.Lines).HasForeignKey(e => e.VendorDebitNoteId).OnDelete(DeleteBehavior.Cascade);
