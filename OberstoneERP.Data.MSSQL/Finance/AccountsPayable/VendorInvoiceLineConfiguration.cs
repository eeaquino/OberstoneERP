...
public class VendorInvoiceLineConfiguration : BaseEntityConfiguration<VendorInvoiceLine>
{
    ...
    {
        builder.ToTable("VendorInvoiceLines", "accountspayable");

        builder.Property(e => e.VendorInvoiceId).HasColumnType("uniqueidentifier").IsRequired();
        builder.HasIndex(e => e.VendorInvoiceId).HasDatabaseName("IX_VendorInvoiceLines_VendorInvoiceId");
        ...
        builder.HasOne(e => e.VendorInvoice).WithMany(vi => vi.Lines).HasForeignKey(e => e.VendorInvoiceId).OnDelete(DeleteBehavior.Cascade);
