...
public class VendorDebitNoteConfiguration : BaseEntityConfiguration<VendorDebitNote>
{
    ...
    {
        builder.ToTable("VendorDebitNotes", "accountspayable");

        builder.Property(e => e.CompanyId).HasColumnType("uniqueidentifier").IsRequired();
        builder.HasIndex(e => e.CompanyId).HasDatabaseName("IX_VendorDebitNotes_CompanyId");
        ...
        builder.HasIndex(e => e.VendorId).HasDatabaseName("IX_VendorDebitNotes_VendorId");
        builder.Property(e => e.OriginalInvoiceId).HasColumnType("uniqueidentifier");
        builder.Property(e => e.DebitNoteNumber).HasMaxLength(50).IsRequired();
        builder.HasIndex(e => new { e.CompanyId, e.DebitNoteNumber }).IsUnique().HasDatabaseName("IX_VendorDebitNotes_CompanyId_DebitNoteNumber");
        builder.Property(e => e.DebitNoteDate).HasColumnType("datetime2").IsRequired();
        ...
        builder.Property(e => e.Status).HasConversion<int>().HasDefaultValue(VendorDebitNoteStatus.Draft).IsRequired();
        ...
        builder.HasOne(e => e.Vendor).WithMany(v => v.DebitNotes).HasForeignKey(e => e.VendorId).OnDelete(DeleteBehavior.Restrict);
