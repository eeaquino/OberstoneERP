...
public class CustomerConfiguration : BaseEntityConfiguration<Customer>
{
    ...
    protected override void ConfigureEntity(EntityTypeBuilder<Customer> builder)
    {
        ...
        builder.HasIndex(e => e.CompanyId).HasDatabaseName("IX_Customers_CompanyId");
        builder.Property(e => e.CustomerGroupId).HasColumnType("uniqueidentifier");
        builder.Property(e => e.CustomerNumber).HasMaxLength(50).IsRequired();
        builder.HasIndex(e => new { e.CompanyId, e.CustomerNumber }).IsUnique().HasDatabaseName("IX_Customers_CompanyId_CustomerNumber");
        builder.Property(e => e.Name).HasMaxLength(200).IsRequired();
        builder.HasIndex(e => new { e.CompanyId, e.Name }).HasDatabaseName("IX_Customers_CompanyId_Name");
        builder.Property(e => e.LegalName).HasMaxLength(300);
        builder.Property(e => e.CustomerType).HasConversion<int>().HasDefaultValue(CustomerType.Business).IsRequired();
        ...
        builder.Property(e => e.DefaultCurrencyId).HasColumnType("uniqueidentifier");
        ...
        builder.Property(e => e.CreditUsed).HasColumnType("decimal(19,4)").HasDefaultValue(0m).IsRequired();
        builder.Ignore(e => e.CreditAvailable);
        builder.Property(e => e.CreditCheckEnabled).HasDefaultValue(true).IsRequired();
        builder.Property(e => e.CreditStatus).HasConversion<int>().HasDefaultValue(CreditStatus.Good).IsRequired();
        builder.Property(e => e.AccountsReceivableBalance).HasColumnType("decimal(19,4)").HasDefaultValue(0m).IsRequired();
        builder.Property(e => e.DefaultTaxCodeId).HasColumnType("uniqueidentifier");
        builder.Property(e => e.IsTaxExempt).HasDefaultValue(false).IsRequired();
        builder.Property(e => e.TaxExemptionNumber).HasMaxLength(100);
        ...
        builder.HasOne(e => e.CustomerGroup).WithMany(cg => cg.Customers).HasForeignKey(e => e.CustomerGroupId).OnDelete(DeleteBehavior.Restrict);
        builder.HasOne(e => e.DefaultCurrency).WithMany().HasForeignKey(e => e.DefaultCurrencyId).OnDelete(DeleteBehavior.Restrict);
