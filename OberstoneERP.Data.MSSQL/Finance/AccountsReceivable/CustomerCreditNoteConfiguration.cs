...
public class CustomerCreditNoteConfiguration : BaseEntityConfiguration<CustomerCreditNote>
{
    ...
    protected override void ConfigureEntity(EntityTypeBuilder<CustomerCreditNote> builder)
    {
        ...
        builder.HasIndex(e => e.CompanyId).HasDatabaseName("IX_CustomerCreditNotes_CompanyId");
        builder.Property(e => e.SiteId).HasColumnType("uniqueidentifier");
        builder.Property(e => e.CustomerId).HasColumnType("uniqueidentifier").IsRequired();
        builder.HasIndex(e => e.CustomerId).HasDatabaseName("IX_CustomerCreditNotes_CustomerId");
        builder.Property(e => e.OriginalInvoiceId).HasColumnType("uniqueidentifier");
        builder.Property(e => e.CreditNoteNumber).HasMaxLength(50).IsRequired();
        builder.HasIndex(e => new { e.CompanyId, e.CreditNoteNumber }).IsUnique().HasDatabaseName("IX_CustomerCreditNotes_CompanyId_CreditNoteNumber");
        builder.Property(e => e.CreditNoteDate).HasColumnType("datetime2").IsRequired();
        ...
        builder.Property(e => e.AppliedAmount).HasColumnType("decimal(19,4)").HasDefaultValue(0m).IsRequired();
        ...
        builder.Property(e => e.Status).HasConversion<int>().HasDefaultValue(CustomerCreditNoteStatus.Draft).IsRequired();
        ...
        builder.HasOne(e => e.Customer).WithMany(c => c.CreditNotes).HasForeignKey(e => e.CustomerId).OnDelete(DeleteBehavior.Restrict);
        builder.HasOne(e => e.OriginalInvoice).WithMany().HasForeignKey(e => e.OriginalInvoiceId).OnDelete(DeleteBehavior.Restrict);
