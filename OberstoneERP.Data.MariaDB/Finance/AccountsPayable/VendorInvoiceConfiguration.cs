...
public class VendorInvoiceConfiguration : BaseEntityConfiguration<VendorInvoice>
{
    ...
    protected override void ConfigureEntity(EntityTypeBuilder<VendorInvoice> builder)
    {
        ...
        builder.HasIndex(e => e.CompanyId)
            .HasDatabaseName("IX_VendorInvoices_CompanyId");
        ...
        builder.HasIndex(e => e.VendorId)
            .HasDatabaseName("IX_VendorInvoices_VendorId");
        ...
        builder.HasIndex(e => new { e.CompanyId, e.InvoiceNumber })
            .IsUnique()
            .HasDatabaseName("IX_VendorInvoices_CompanyId_InvoiceNumber");
        ...
        builder.HasIndex(e => new { e.VendorId, e.VendorInvoiceNumber })
            .HasDatabaseName("IX_VendorInvoices_VendorId_VendorInvoiceNumber");
        ...
        builder.HasIndex(e => new { e.CompanyId, e.DueDate })
            .HasDatabaseName("IX_VendorInvoices_CompanyId_DueDate");
        ...
        builder.Property(e => e.WithholdingTaxAmount)
            .HasColumnType("decimal(19,4)")
            .HasDefaultValue(0m)
            .IsRequired();
        ...
        builder.Property(e => e.Status)
            .HasConversion<int>()
            .HasDefaultValue(VendorInvoiceStatus.Draft)
            .IsRequired();
