...
public class CustomerCreditNoteLineConfiguration : BaseEntityConfiguration<CustomerCreditNoteLine>
{
    ...
    {
        builder.ToTable("CustomerCreditNoteLines");

        builder.Property(e => e.CustomerCreditNoteId).HasColumnType("char(36)").IsRequired();
        ...
        builder.Property(e => e.AccountId).HasColumnType("char(36)").IsRequired();
