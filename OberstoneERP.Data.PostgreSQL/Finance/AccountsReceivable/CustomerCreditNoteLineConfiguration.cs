...
public class CustomerCreditNoteLineConfiguration : BaseEntityConfiguration<CustomerCreditNoteLine>
{
    ...
    protected override void ConfigureEntity(EntityTypeBuilder<CustomerCreditNoteLine> builder)
    {
        ...
        builder.Property(e => e.CustomerCreditNoteId)
            .HasColumnType("uuid")
            .IsRequired();

        builder.HasIndex(e => e.CustomerCreditNoteId)
            .HasDatabaseName("IX_CustomerCreditNoteLines_CustomerCreditNoteId");
        ...
        builder.HasOne(e => e.CustomerCreditNote)
            .WithMany(ccn => ccn.Lines)
            .HasForeignKey(e => e.CustomerCreditNoteId)
