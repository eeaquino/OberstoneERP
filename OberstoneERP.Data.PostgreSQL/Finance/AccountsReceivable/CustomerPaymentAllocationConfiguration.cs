...
public class CustomerPaymentAllocationConfiguration : BaseEntityConfiguration<CustomerPaymentAllocation>
{
    ...
    {
        builder.ToTable("CustomerPaymentAllocations", "accountsreceivable");

        builder.Property(e => e.CustomerPaymentId)
            .HasColumnType("uuid")
            .IsRequired();

        builder.HasIndex(e => e.CustomerPaymentId)
            .HasDatabaseName("IX_CustomerPaymentAllocations_CustomerPaymentId");
        ...
        builder.HasIndex(e => e.CustomerInvoiceId)
            .HasDatabaseName("IX_CustomerPaymentAllocations_CustomerInvoiceId");
        ...
        builder.Property(e => e.WriteOffAmount)
            .HasColumnType("decimal(19,4)")
            .HasDefaultValue(0m)
            .IsRequired();
